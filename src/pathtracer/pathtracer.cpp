...
Vector3D PathTracer::at_least_one_bounce_radiance(const Ray &r,
  ...
  new_ray.fog_density = r.fog_density;
#ifdef FOG_ON
  double fd = isect.bsdf->get_fog_density(w_out);
  new_ray.fog_density += isect.bsdf->get_fog_density(w_out);
#endif
  new_ray.min_t = EPS_F;
